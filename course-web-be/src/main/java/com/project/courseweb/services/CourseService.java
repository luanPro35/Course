...
public interface CourseService {
    CourseResponse createCourse(CourseCreateRequest request, MultipartFile file);

//    FileResponse uploadCourseThumbnail(MultipartFile file);

//    CourseResponse updateCourseInfo(Long id, CourseUpdateRequest request);

    CourseResponse updateCourseIngredient(Long id, CourseIngredientUpdateRequest request, MultipartFile file);
